...
wm.types = {
	"types": {
		...
		"com.crcptestdb.data.Jishahaikibutsu": {
			"fields": {
				"jishahaikiCategory": {
					"exclude": [],
					"fieldOrder": 2,
...
dojo.declare("CRCP", wm.Application, {
